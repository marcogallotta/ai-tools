...
new_trigger="trigger='fast-track override'"
...
new_text="    'text':'Fast-track override: read the triggered Procedure before use.',"
...
"""
new_test="""        assert 'Fast-track override: read the triggered Procedure before use.' in rendered
        assert 'fast-track override' in rendered
        assert 'dish/docs/agents/fast-track-process.md#Procedure' in rendered
"""
