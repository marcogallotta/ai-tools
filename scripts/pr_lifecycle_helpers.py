...
# Pre-PR host provenance must reconstruct to the independent operator handoff record;
# this override intentionally supersedes the cache-only helper imported above.
