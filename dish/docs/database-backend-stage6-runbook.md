...
The repository can migrate an empty target through `0012_task_grant_semantic_identity`, execute the Stage 1–6
...
- PostgreSQL schema head `0012_task_grant_semantic_identity`.
...
```json
{
  ...
  "schema_head": "0012_task_grant_semantic_identity",
...
- the database is at `0012_task_grant_semantic_identity`;
