...
- Immediately before any Asana write, resolve the exact target project and freshly read/apply `dish/docs/agents/asana-project-contracts.md`; unregistered, ambiguous, unreadable, or contradictory project contracts perform zero mutation. Preserve project-specific semantics and authoritatively read back state-changing writes.
