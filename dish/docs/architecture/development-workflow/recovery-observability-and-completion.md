...
A preserved clean Implementation worktree may be fast-forwarded across an
Integration refresh only as part of an exact formal Review-BLOCK handoff. That
