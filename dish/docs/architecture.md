...
| private frontend product or delivery work | [`frontend.md`](frontend.md), [`frontend-imp.md`](frontend-imp.md), and the current Gate A readiness packet when integrating authentication/runtime work |
