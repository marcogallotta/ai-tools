...
| private frontend product or delivery work | [`frontend.md`](frontend.md), [`frontend-imp.md`](frontend-imp.md), [`frontend-stage2-runtime-decisions.md`](frontend-stage2-runtime-decisions.md), the current Gate A packet for authentication/runtime integration, [`frontend-db-migration-reconciliation.md`](frontend-db-migration-reconciliation.md), and the current Gate B source map for canonical board/detail integration |
