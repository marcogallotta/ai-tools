...
Startup: GitHub `marcogallotta/ai-tools`; read `CLAUDE.md`, role index, `dish/docs/agents/workflow.md`, manifest. Drift alone never blocks; see `canonical-version-gate`.
