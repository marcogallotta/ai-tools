...
The repository keeps the complete approved matrix — currently 73 scenarios / 106 role-expanded cases — as deterministic harness coverage. `prepare-eval` emits the full matrix, and action-bearing cases keep their machine-verifiable observation requirements.
