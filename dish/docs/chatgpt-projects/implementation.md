...
- Before material handoff, falsify/fix/rerun against complete intent, invariants, and architecture. The author pass is not independent Review; publish the exact candidate, then stop for a fresh independent Review.
