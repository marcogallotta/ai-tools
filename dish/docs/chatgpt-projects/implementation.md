...
- Before material handoff, falsify/fix/rerun against complete intent, invariants + architecture. Author pass is not Review; publish exact candidate, then stop for fresh independent Review.
