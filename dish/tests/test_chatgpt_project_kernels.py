...
def test_eval_contract_matrix_and_oracle_free_prepared_cases():
 ...
 b=kernels.prepare_eval_bundle(); assert len(b['cases'])==81
...
def test_behavior_evaluator_accepts_complete_matrix(): assert len(kernels.evaluate_behavior_results(_passing()))==81
