...
def _upgrade_on(connection,url):
    c=Config(str(ROOT/"alembic.ini")); c.set_main_option("sqlalchemy.url",url); c.attributes["connection"]=connection; command.upgrade(c,"0025_reconciliation_observation_boundary")
