...
class ReleaseCandidateManifest(Base):
    ...
    __table_args__ = (
        CheckConstraint("manifest_version IN (2, 3, 4, 5)", name="manifest_version_supported"),
        CheckConstraint(
        ...
        CheckConstraint(
            ...
            "(manifest_version IN (3, 4, 5) AND approval_reconciliation_run_id IS NOT NULL "
...
class CandidateManifestRevalidation(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            "((manifest_version = 2 AND observed_readiness_inventory_sha256 IS NOT NULL "
            ...
            "(manifest_version IN (3, 4, 5) AND observed_readiness_inventory_sha256 IS NULL "
