...
This registry owns the ordinary connected surface used by MCP and,
...
_READ_DESCRIPTIONS = {
    ...
    "query": "Query active and cooked Dishes by canonical content, placement, workflow, and dates.",
