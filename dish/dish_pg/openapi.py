...
def postgres_action_openapi(*, server_url: str = "https://dish-postgresql.example.invalid") -> dict[str, Any]:
    ...
    for command in ACTION_COMMANDS:
        ...
        if command == SEARCH_COMMAND:
            ...
            description = (
                "Read-only current cooked-history discovery over a generation-fenced fixed window. "
                "Use the returned generation_id and through as the next successful-pass watermark; "
