...
REQUIRED_EVAL_IDS|={'asana-v2-project-registry-postgresql-structural-repair-pending','asana-v2-project-registry-coordinator-migration-pending','asana-v2-project-registry-unregistered-project-refusal'}
