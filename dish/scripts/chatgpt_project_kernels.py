...
REQUIRED_EVAL_IDS={'emergency-attach-eligible', 'emergency-attach-parent-mismatch', 'emergency-attach-tree-mismatch', 'emergency-attach-branch-race', 'emergency-attach-after-review', 'emergency-attach-asana-authority-revoked', 'emergency-attach-policy-denial', 'emergency-attach-conflicting-writer', 'emergency-attach-forbids-semantic-actions', 'emergency-attach-consumed-once', 'emergency-attach-final-readback-required', 'emergency-attach-normal-broker-path-unchanged', 'scope-amplification-checkpoint', 'publication-materializer-eligible-blocker', 'compatible-wording-drift', 'project-drift-self-compatible', 'integration-rejects-head-mismatch', 'current-template-lookup', 'compatible-concise-output-drift', 'durable-review-classification', 'handoff-conflicts-with-role-authority', 'publication-handoff-before-human-notification', 'authenticated-account-not-human-decision', 'project-drift-pre-d96-legacy', 'publication-blocker-forbids-unsafe-shortcuts', 'integration-bounded-reconciliation', 'publication-unsafe-governed-path-blocker', 'supported-operation-stays-local-system-access', 'code-smell-dedupe-log-and-continue', 'forbidden-implicit-role-expansion', 'code-smell-true-blocker-stays-active', 'shared-resource-concurrency-preflight', 'unrelated-role-drift', 'implementation-escalation-is-action-first', 'live-authority-over-stale-memory', 'project-drift-v708-review-compatible', 'coordinator-pr-intake-automatic-review', 'chat-only-review-verdict-not-complete', 'project-drift-integrity-error', 'audit-moved-baseline-current-blocker', 'repository-friction-discovery', 'development-workflow-pr60-test-scope-context', 'allowed-specialist-implementation-composition', 'review-breaking-completion-drift', 'publication-completion-invalidates-prior-review', 'action-first-lifecycle-output', 'active-gate-blocker-cannot-be-deferred', 'skipped-version-breaking-drift', 'no-valid-fallback', 'valid-action-fallback', 'development-workflow-context-preload-no-authority', 'additive-evidence-drift', 'friction-active-blocker-routes-to-active-work', 'integration-breaking-merge-drift', 'implementation-rejects-patch-only-completion', 'separate-pr-does-not-clear-independent-blocker', 'development-workflow-pr40-fallback-context', 'disposable-fixture-still-needs-health', 'audit-missing-authority-fails-closed', 'audit-new-finding-backlog-only', 'configured-repository-pr-routing', 'stale-project-version', 'task-history-before-no-op', 'audit-dedupe-existing-finding', 'comparison-incompatible-target-escalates-implementation', 'coordinator-check-everything-mixed-state', 'reviewed-head-movement-classification', 'friction-dedupe-no-urgency', 'audit-refuses-mutation-authority', 'project-drift-current-silent', 'cross-role-context-bleed', 'publication-fully-published-local-certification', 'audit-specialist-context-no-authority', 'post-merge-asana-residual-gate', 'skipped-version-nonbreaking-drift', 'failed-ci-ownership-before-fix', 'mutation-broker-proof-required', 'review-exact-head-completion', 'audit-exact-baseline'}
