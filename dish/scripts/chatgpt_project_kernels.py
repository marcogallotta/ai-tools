...
REQUIRED_EVAL_IDS={'audit-refuses-mutation-authority', 'audit-specialist-context-no-authority', 'audit-missing-authority-fails-closed', 'durable-review-classification', 'review-remote-local-evidence-pr-handoff', 'live-authority-over-stale-memory', 'implementation-rejects-patch-only-completion', 'forbidden-implicit-role-expansion', 'publication-handoff-before-human-notification', 'audit-moved-baseline-current-blocker', 'review-local-evidence-direct', 'development-workflow-pr60-test-scope-context', 'compatible-wording-drift', 'valid-action-fallback', 'review-breaking-completion-drift', 'code-smell-true-blocker-stays-active', 'friction-active-blocker-routes-to-active-work', 'audit-exact-baseline', 'chat-only-review-verdict-not-complete', 'development-workflow-terminal-role-routing', 'publication-completion-invalidates-prior-review', 'authenticated-account-not-human-decision', 'friction-dedupe-no-urgency', 'publication-fully-published-local-certification', 'publication-blocker-forbids-unsafe-shortcuts', 'repository-friction-discovery', 'unrelated-role-drift', 'cross-role-context-bleed', 'configured-repository-pr-routing', 'integration-rejects-head-mismatch', 'skipped-version-breaking-drift', 'review-local-integration-routes-integration', 'integration-breaking-merge-drift', 'task-history-before-no-op', 'development-workflow-context-preload-no-authority', 'review-passed-certification-pending', 'compatible-concise-output-drift', 'audit-dedupe-existing-finding', 'publication-unsafe-governed-path-blocker', 'no-valid-fallback', 'skipped-version-nonbreaking-drift', 'stale-project-version', 'additive-evidence-drift', 'review-local-semantic-fix-routes-implementation', 'coordinator-check-everything-mixed-state', 'shared-resource-concurrency-preflight', 'audit-new-finding-backlog-only', 'coordinator-pr-intake-automatic-review', 'implementation-publication-readback-mismatch', 'reviewed-head-movement-classification', 'handoff-conflicts-with-role-authority', 'implementation-publication-readback-success', 'allowed-specialist-implementation-composition', 'development-workflow-pr40-fallback-context', 'review-exact-head-completion', 'current-template-lookup', 'code-smell-dedupe-log-and-continue'}
