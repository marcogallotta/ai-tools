...
def design_principles_rule(s):
 ...
 if not isinstance(ids,list) or len(ids)!=10 or len(set(ids))!=10 or any(not re.fullmatch(r'DP-\d{2}',str(x)) for x in ids): raise KernelError('design_principles requires ten stable DP-NN principle_ids')
...
REQUIRED_EVAL_IDS|={'development-workflow-asana-legacy-mode','development-workflow-asana-legacy-incomplete-abort','development-workflow-asana-v2-mode','development-workflow-asana-v3-abort','development-workflow-asana-contradiction-abort','development-workflow-asana-unknown-version-abort','development-workflow-asana-v2-degraded-present-write','development-workflow-asana-v2-degraded-target-repair'}
...
REQUIRED_EVAL_IDS|={'development-workflow-structured-fields-raw-intake','development-workflow-structured-fields-owner-transfer','development-workflow-structured-fields-version-successor','development-workflow-structured-fields-approved-headline-paraphrase','development-workflow-structured-fields-unapproved-candidate','development-workflow-structured-fields-headline-no-versus-blank','development-workflow-structured-fields-legacy-headline-no-gate','development-workflow-structured-fields-code-area-scope-change','development-workflow-structured-fields-cannot-mint-authority'}
REQUIRED_EVAL_IDS|={'epistemic-implementation-self-service-answer','epistemic-implementation-marco-only-material-fact','epistemic-implementation-nonmaterial-choice-continues','epistemic-implementation-design-reality-contradiction','epistemic-implementation-takeover-preserves-gap','epistemic-implementation-green-tests-insufficient','epistemic-implementation-confidence-not-authority'}
REQUIRED_EVAL_IDS|={'scope-baseline-rejects-historical-reconstruction','scope-missing-baseline-routes-authority','scope-one-baseline-before-during-after','scope-historical-future-remains-reserved','scope-trivial-change-no-mandatory-plan','scope-small-high-consequence-keeps-controls','scope-second-attempt-must-change','scope-necessary-complexity-routes-design','scope-generated-volume-tripwire-only','scope-new-control-plane-braked'}
REQUIRED_EVAL_IDS|={'coordinator-concurrency-nonoverlap-start-wait','coordinator-concurrency-exact-sounding-noncause','coordinator-concurrency-true-causal-wait','coordinator-concurrency-sticky-independence','coordinator-concurrency-drain-reasoning-frontier','coordinator-concurrency-omitted-p0'}
REQUIRED_EVAL_IDS|={'asana-v2-project-registry-postgresql-degraded-present-transition','asana-v2-project-registry-degraded-unrelated-field-write','asana-v2-project-registry-degraded-target-repair','asana-v2-project-registry-degraded-target-no-repair-authority','asana-v2-project-registry-duplicate-meaning-contradictory','asana-v2-project-registry-ambiguous-repair-write','asana-v2-project-registry-complete-unchanged','asana-v2-project-registry-coordinator-legacy-bare-name','asana-v2-project-registry-unknown-version-stop-and-flag','asana-v2-project-registry-unregistered-project-refusal'}
...
REQUIRED_EVAL_IDS|={'handoff-ux-locator-first','handoff-ux-exact-inline-boundary','handoff-ux-either-limit-cutover','handoff-ux-local-temp-file','handoff-ux-chatgpt-artifact','handoff-ux-chatgpt-artifact-unavailable','handoff-ux-replacement-not-addenda','handoff-ux-no-manual-relay','handoff-ux-receiver-grounding'}
REQUIRED_EVAL_IDS|={'review-wording-ordinary-block','review-wording-bounded-authorization','review-wording-recommendation-not-approval','review-wording-human-ambiguity','review-wording-no-action-needed'}
REQUIRED_EVAL_IDS|={'implementation-start-derives-fresh-identity','implementation-start-missing-prefill-no-block','implementation-start-conflicting-lineage-blocks','implementation-start-stale-derived-base-refuses','implementation-start-existing-pr-no-rederive','implementation-start-chatgpt-prelaunch-derived','implementation-start-local-authority-no-redundant-asana','implementation-start-claim-boundary'}
REQUIRED_EVAL_IDS|={'implementation-active-authoring-ignores-unrelated-target-movement','implementation-active-authoring-reconciles-only-proven-boundary'}
REQUIRED_EVAL_IDS|={'coordinator-loop-action-first-fallback','coordinator-loop-drain-fallback','coordinator-loop-additive-off','coordinator-loop-projection-normal-input','coordinator-loop-projection-unknown','coordinator-loop-post-model-wait-refusal','coordinator-loop-local-benefit-infrastructure','coordinator-loop-local-benefit-convenience-rejected','coordinator-loop-local-benefit-remote-available','coordinator-loop-hosted-default','coordinator-loop-stop-reset-outer-fence','coordinator-loop-source-backend-equivalence','coordinator-loop-restart-recovery','coordinator-loop-zero-idle-turn','coordinator-loop-versioned-telemetry'}
REQUIRED_EVAL_IDS|={'review-v5-semantic-change-no-human-approval','review-v5-routine-code-no-human-review','review-v5-repairable-metadata','review-v5-hard-admission-ambiguity','review-v5-stale-generation-approval','review-v5-projection-only-parity','review-v5-helper-no-classification','review-v5-headline-remove-jargon'}
REQUIRED_EVAL_IDS|={'pcritical-coordinator-created-closeout','pcritical-audit-authoritative-route','pcritical-review-routes-no-implementation-authority','pcritical-authorized-execution-continues','pcritical-material-unknown-active-research','pcritical-external-dependency-owned-wake','pcritical-unproven-does-not-invent','pcritical-no-authority-expansion'}
