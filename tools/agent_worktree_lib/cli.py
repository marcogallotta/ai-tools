...
def build_parser() -> argparse.ArgumentParser:
    ...
    cleanup.add_argument("--branch", required=True, help="exact terminal agent/* branch bound to the PR")
    cleanup.add_argument("--expected-head", required=True, help="exact terminal PR head SHA")
    cleanup.add_argument("--pr-number", required=True, type=int, help="positive terminal PR number retained in cleanup provenance")
    cleanup.add_argument("--observed-state", choices=("merged", "closed"), help="fresh terminal GitHub state")
    cleanup.add_argument("--observed-at", help="timestamp of the final GitHub terminal identity read")
