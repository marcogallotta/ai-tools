...
def build_parser() -> argparse.ArgumentParser:
    ...
    claim.add_argument("--base", help="exact authoring base SHA for the durable global claim; inferred from wrapped start/adopt or existing task state when omitted")
    claim.add_argument("--session-id", help="durable session provenance for the global claim")
    claim.add_argument("--global-claim-id", help="exact current global claim id for same-generation continuation")
    ...
    claim.add_argument("--expected-global-claim", help="exact prior durable global claim id required with --takeover")
    claim.add_argument("--takeover-reason", help="explicit orchestration reason for global ownership transfer")
    claim.add_argument("--liveness-evidence", help="bounded evidence supporting explicit global ownership transfer")
